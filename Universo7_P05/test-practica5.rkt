...
(test(parse '{ with* {{ a 2} { b {+ a a }}}b})(withS*
 (list (binding 'a (numS 2)) (binding 'b (opS + (list (idS 'a) (idS 'a)))))
 (idS 'b)))
...
(test(parse '{with {{x {* 5 5}}} {with {{y {- x 3}}} {+ y y}}})(withS
 (list (binding 'x (opS * (list (numS 5) (numS 5)))))
 (withS
  (list (binding 'y (opS - (list (idS 'x) (numS 3)))))
  (opS + (list (idS 'y) (idS 'y))))))
